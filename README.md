...
* Загрузить Vagrantfile и ansible playbooks: https://github.com/exarmic/ansible-vagrant.git 
...
На проработать - изучить настройки apache для воможности образения к админке сервера FreeIPA по адресу localhost
